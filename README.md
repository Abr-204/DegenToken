...
```solidity
function transferTokens(address _receiver, uint 256amount) external
```
...
```solidity
function burnTokens(uint 256amount) public
```
...
```solidity
function redeemSword(uint 256 quantity) public
```
